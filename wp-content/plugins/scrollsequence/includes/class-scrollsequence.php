...
class Scrollsequence {
	...
	private function define_admin_hooks() {
		...
		// register scrollsequence_preview_media
		$this->loader->add_action( 'init', $plugin_admin, 'scrollsequence_preview_media' );  
		$this->loader->add_action( 'admin_head', $plugin_admin, 'scrollsequence_preview_media_hide_submenu_page' ); 
